...
def conectar_db():
    ...
    # Adicionar a definição da tabela "produtos"
    cursor.execute('''
...
def obter_todos_produtos_cadastrados():
    conn, cursor = conectar_db()
...
def cadastrar_venda(item, preco, quantidade, tipo_quantidade, tipo_pagamento):
    ...
    # Verificar se o produto já está cadastrado; se não, cadastrar
    cadastrar_produto_se_necessario(item, preco, quantidade, tipo_quantidade, tipo_pagamento)
